...
import { 
    ...
    Hash, FileX, Unlock, LayoutGrid, Tag, Globe, FileEdit, FileSpreadsheet, Presentation, 
    Eye, 
} from "lucide-react";
...
const Home = () => {
    ...
    const categories = [
        ...
        { id: 'PDF Tools', title: 'PDF Tools', icon: FileText, color: 'text-rose-600', bg: 'bg-rose-50', count: 22 },
...
// নিচে নতুন Conversion Tools গুলো যোগ করা হলো (এগুলো আপনি ConverterPage.jsx দিয়ে হ্যান্ডেল করছেন)
{ title: "PDF to Word", path: "/pdf-to-word", icon: FileText, category: "PDF Tools", desc: "Convert PDF documents to editable Word format.", color: "bg-rose-500" },
{ title: "Word to PDF", path: "/word-to-pdf", icon: FileText, category: "PDF Tools", desc: "Convert Word documents to professional PDF format.", color: "bg-rose-500" },
{ title: "PDF to Excel", path: "/pdf-to-excel", icon: FileSpreadsheet, category: "PDF Tools", desc: "Extract data from PDF to Excel spreadsheets.", color: "bg-rose-500" },
{ title: "Excel to PDF", path: "/excel-to-pdf", icon: FileSpreadsheet, category: "PDF Tools", desc: "Convert Excel spreadsheets to PDF format.", color: "bg-rose-500" },
{ title: "PDF to PowerPoint", path: "/pdf-to-powerpoint", icon: Presentation, category: "PDF Tools", desc: "Convert PDF to editable PowerPoint slideshows.", color: "bg-rose-500" },
{ title: "PowerPoint to PDF", path: "/powerpoint-to-pdf", icon: Presentation, category: "PDF Tools", desc: "Convert PowerPoint slideshows to PDF format.", color: "bg-rose-500" },
        // Video Tools
